        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-3 col-6">
                    <div class="_kl_de_w">
                        <h3>Arka Techi</h3>
                        <p>Waiting for an opportunity in the IT world, let’s walk together and make it possible for your bright and lightning carrier.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-3 col-6">
                    <div class="_kl_de_w">
                        ...
                        <ol>
                            ...
                            <li><i class="far fa-angle-right"></i>Firewall</li>
    ...
    <div class="end-footer">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="last-card">
                        <p>© 2022 All Rights Reserved by<a href="https://www.smarteyeapps.com">ArkaTechi</a></p>
                    </div>
                </div>
            </div>
        </div>
