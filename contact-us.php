          ...
          <div class="row align-items-stretch no-gutters contact-wrap">
            ...
            <div class="col-md-4">
              <div class="contact-info h-100">
                ...
                <p class="mb-5">If you have any questions or queries a member of our staff will always be happy to help. Feel free to contact us by telephone or email and we'll be sure to get back to you as soon as possible.</p>
                <div class="h-100">
                  <h3>Contact Details</h3>
                    <ol>
                        <li><i class="far fa-map-marker-check"></i> INDIA</li>
                        <li><i class="fal fa-mobile"></i> <a style="color:#FFFFFF80"; href="tel:+91-9689190202"> +91 9689190202 </a></li>
                        <li><i class="fal fa-envelope"></i><a style="color:#FFFFFF80"; href="mailto:info@arkatechi.com"> info@arkatechi.com</a></li>
                        <li><i class="fal fa-clock"></i> Mon - Fri 10.00 - 18.00.</li>
                    </ol>
                </div>
              </div>
            </div>
