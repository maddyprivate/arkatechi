                    ...
                    <div class="main-wrapper">
                        <div class="sub-wrapper-01">
                            <div class="content">
                                ...
                                <div class="btn-01">
                                    <ul>
                                <li><a href="assets/doc/Arkatechi.pdf" target="_blank" class="new-btn ">To know more about us</a></li>
                            </ul>
                        </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                        <div class="main-wrapper">
                            <div class="content text-center">
                                ...
                                <div class="sentence">
                                    <h3>DEVELOPMENT</h3>
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis molestias excepturi fugit, similique laborum
                                    necessitatibus?</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                        <div class="main-wrapper">
                            <div class="content text-center">
                                ...
                                <div class="sentence">
                                    <h3>BUSINESS</h3>
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis molestias excepturi fugit, similique
                                        laborum
                                        necessitatibus?</p>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                        <div class="_lk_bg_cd">
                            ...
                            <div class="counting" data-count="3">100</div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                        <div class="_lk_bg_cd">
                            ...
                            <div class="counting" data-count="90">100</div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                        <div class="_lk_bg_cd">
                            ...
                            <div class="counting" data-count="102">100</div>
